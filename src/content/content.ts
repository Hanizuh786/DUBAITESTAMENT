...
Bij de Koninklijke Notariële Beroepsorganisatie in Den Haag was Hilda manager van de afdelingen Praktijkzaken en Juridische Zaken (hieronder vallen ook het voor notarissen toepasselijke tuchtrecht en het WPNR tijdschrift). Zij gaf leiding aan twintig juristen en maakte deel uit van het MT.`,
  },
  {
    ...
    body: `Uit het testamentgesprek kan blijken dat je naast testamenten ook andere regelingen nodig hebt. Huwelijkse voorwaarden bepalen bijvoorbeeld wat van iedere partner is. Een testament bepaalt daarna wat er na een overlijden met dat vermogen gebeurt. Beide regelingen moeten daarom op elkaar aansluiten.
